...
export default function HalfyearPartOne() {
  return (
    <CourseLayout>
      <header>Полугодовой курс ОГЭ</header>
      <section className={style.informationAboutCourse}>
        <article className="spawnItem">
          ...
          <ul className="content">
            <li>За 6 месяцев разберем все задания 1 части экзамена</li>
      ...
      <section className={style.examples}>
        <article>
          ...
          <iframe
            width="100%"
            src="https://rutube.ru/play/embed/d47fb9cf7a356650071e4a479c49e6b2"
        ...
        <article>
          ...
          <div className={style.image} style={{ aspectRatio: "909 / 1280" }}>
            <Image
              src="/courses/oge/halfyear/solution.jpg"
        ...
        <article>
          ...
          <div className={style.image} style={{ aspectRatio: "903 / 1280" }}>
            <Image
