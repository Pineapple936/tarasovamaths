      ...
      <section className={style.examples}>
        ...
        <article>
          <div className={style.image} style={{ aspectRatio: "1290 / 1757" }}>
            <Image src="/courses/oge/guide-1-5/1.PNG" alt="Фотография гайда" fill loading="lazy" />
          </div>
        </article>
        <article>
          <div className={style.image} style={{ aspectRatio: "1290 / 1757" }}>
            <Image src="/courses/oge/guide-1-5/2.PNG" alt="Фотография гайда" fill loading="lazy" />
          </div>
        </article>
      </section>
