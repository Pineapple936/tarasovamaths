    ...
    <CourseLayout>
      ...
      <section className={style.informationAboutCourse}>
        <article className="spawnItem">
          ...
          <ul className="content">
            ...
            <li>
              Идете на оценку 4 и хотите подстраховаться дополнительными баллами из задач второй
              части
            </li>
            <li>Идете на оценку 5 или в профильный класс/колледж</li>
            <li>Вам лучше дается геометрия, чем алгебра</li>
          </ul>
        </article>
        <article className="spawnItem">
          ...
          <ul className="content">
            <li>Всего за один месяц вы освоите задания № 23−25</li>
            ...
            <li>
              Получите много практики по каждому заданию, а также удобные чек-листы с теорией — не
              надо ничего искать в учебнике
            </li>
          </ul>
        </article>
        <div className="button-link">
          <Link href="/services/oge/hard-geometry/details">Подробнее о курсе</Link>
        </div>
      </section>
        ...
        <article className={style.tariffs}>
          <div className="cell">
            ...
            <ul>
              ...
              <li>
                Домашние задания <b>с подробным текстовым решением</b>
              </li>
          ...
          <div className="cell">
            ...
            <ul>
              <li>Все занятия в записи</li>
              <li>
                Домашние задания <b>с проверкой от преподавателя</b>
              </li>
              <li>Чек-листы с теорией</li>
              <li>Бонусный урок</li>
      ...
      <section className={style.examples}>
        <article>
          ...
          <iframe
            width="100%"
            src="https://rutube.ru/play/embed/06485afb2fba7286f604b9f90ba1dfa1"
        ...
        <article>
          ...
          <div className={style.image} style={{ aspectRatio: "909 / 1280" }}>
            <Image
              src="/courses/oge/geometry/homework.jpg"
