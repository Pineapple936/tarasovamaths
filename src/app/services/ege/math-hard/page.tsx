    ...
    <CourseLayout>
      ...
      <section style={{ display: "flex", flexDirection: "column", gap: "40px" }}>
        <div className="spawnItem">
          ...
          <label htmlFor="plan13">
            <i className="bx bx-chevron-down" />
          </label>{" "}
          План обучения №13
          <div className="content">
            <p>
              <b>1 неделя: </b>Простейшие тригонометрические уравнения
            </p>
            <p>
              <b>‌2 неделя: </b>Виды тригонометрических уравнений
            </p>
            <p>
              <b>‌3 неделя: </b>Отбор корней
            </p>
            <p>
              <b>‌4 неделя: </b>Тригонометрические уравнения из ЕГЭ
            </p>
            <p>
              <b>‌5 неделя: </b>Смешанные уравнения. Уравнения с ОДЗ
            </p>
            <p>
              <b>6 неделя: </b>Показательные и логарифмические уравнения
            </p>
        ...
        <div className="spawnItem">
          ...
          <label htmlFor="plan15">
            <i className="bx bx-chevron-down" />
          </label>{" "}
          План обучения №15
          <div className="content">
            <p>
              <b>1 неделя: </b>Рациональные неравенства
            </p>
            <p>
              <b>‌2 неделя: </b>Иррациональные уравнения
            </p>
            <p>
              <b>‌3 неделя: </b>Иррациональные неравенства
            </p>
            <p>
              <b>‌4 неделя: </b>Уравнения с модулем
            </p>
            <p>
              <b>‌5 неделя: </b>Неравенства с модулем
            </p>
            <p>
              <b>6 неделя: </b>Показательные неравенства
            </p>
            <p>
              <b>7 неделя: </b>Логарифмические неравенства
            </p>
            <p>‌Критерии оценивания и основные ошибки</p>
          </div>
        </div>
        <div className="spawnItem">
          ...
          <div className="content">
            ...
            <p>
              <b>‌2 неделя: </b>Кредиты. Аннуитетные платежи
            </p>
            <p>
              <b>‌3 неделя: </b>Кредиты. Дифференцированные платежи
            </p>
            <p>
              <b>‌4 неделя: </b>Смешанные задачи на кредиты
            </p>
            <p>
              <b>‌5 неделя: </b>Задачи на оптимальный выбор без введения функции и с введением
              функции
            </p>
            <p>
              <b>6 неделя: </b>Задачи на оптимальный выбор без использования и с использованием
              производной
            </p>
            <p>‌Критерии оценивания и основные ошибки</p>
          </div>
