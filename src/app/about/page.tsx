    ...
    <>
        ...
        <div className={style.content}>
          <article className={style.image}>
            <div style={{ aspectRatio: "2758 / 3861" }}>
              <Image src="/about/photo/greet.JPG" alt="Фотография репетитора" fill priority />
            </div>
          </article>
          <article className={style.info}>
            <header>
              Привет! Меня зовут Тарасова Екатерина.
              <br />Я — репетитор по математике.
            </header>
            <ul>
              <li>
                <i className="bx bx-time-five" /> 7 лет опыта работы репетитором
              </li>
              <li>
                <i className="bx bx-user-check" /> Обучила более 250 учеников, провела более 5.000
                занятий
              </li>
              <li>
                <i className="bx bx-buildings" /> Ученики поступают в МГУ, МГИМО, ВШЭ, РУДН и другие
                ведущие вузы
              </li>
              <li>
                <i className="bx bx-edit-alt" /> Сдавала ОГЭ и ЕГЭ (база и профиль)
              </li>
              <li>
                <i className="bx bx-book-reader" /> Регулярно учусь у экспертов ОГЭ и ЕГЭ
              </li>
            </ul>
            <SocialIcons />
          </article>
      ...
      <section className={style.block} style={{ padding: "0" }}>
        ...
        <div className={style.content} style={{ justifyContent: "space-between" }}>
          <ul className={style.info}>
            <li>
              <i className="bx bx-user-pin" /> У каждого ученика — личный кабинет на платформе
              Younote с материалами для подготовки
            </li>
            <li>
              <i className="bx bx-chalkboard" /> Использую онлайн-доску и интерактивные сервисы
            </li>
            <li>
              <i className="bx bx-edit-alt" /> Домашки и разбор ошибок — отдельно от занятий, без
              спешки
            </li>
            <li>
              <i className="bx bx-book-open" /> Даю всё необходимое: теорию, схемы и понятные
              объяснения
            </li>
            <li>
              <i className="bx bx-message-dots" /> Всегда на связи: отвечаю на вопросы в
              мессенджерах
            </li>
          ...
          <article className={style.image}>
            <div style={{ aspectRatio: "2701 / 3022" }}>
              <Image src="/about/photo/education.JPG" alt="Фотография репетитора" fill priority />
            </div>
          </article>
        </div>
      </section>
      ...
      <section>
        ...
        <article className={style.consultation}>
          <b>
            Провожу бесплатную 30 — минутную консультацию с предварительным тест-мониторингом перед
            началом работы с целью знакомства, обсуждения дальнейшего плана работы и подбора
            удобного формата обучения
          </b>
          <div className="button-link">
